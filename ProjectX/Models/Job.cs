...
public class Job : BaseEntity
{
    ...
    [Column(TypeName = "nvarchar(50)")] public EducationLevel? EducationLevelRequire { get; set; } = EducationLevel.University;
    ...
    [JsonIgnore] public ICollection<ContractType> ContractTypes { get; set; } = new List<ContractType>();
    [JsonIgnore] public ICollection<JobLevel> JobLevels { get; set; } = new List<JobLevel>();
    [JsonIgnore] public ICollection<JobType> JobTypes { get; set; } = new List<JobType>();
